...
namespace Tobii.GameIntegration.Net
{
	...
	public static class TobiiGameIntegrationApi
	{
		...
		public static int GetExtendedViewSensitivityGradientAsPolyLine([In, Out] Vector2d[] allocatedPointsBuf, SensitivityGradientSettings sensitivitySettings)
		{
			...
			if(Is64BitProcess)
			{
				return x64.GetExtendedViewSensitivityGradientAsPolyLine(allocatedPointsBuf, maxPoints, sensitivitySettings);
			}
			else
			{
				return x86.GetExtendedViewSensitivityGradientAsPolyLine(allocatedPointsBuf, maxPoints, sensitivitySettings);
			}
		}
		...
		private static class x86
		{
			...
			[DllImport(TobiiGameIntegrationDll, CallingConvention = CallingConvention.Cdecl)]
			internal static extern int GetExtendedViewSensitivityGradientAsPolyLine([In,Out] Vector2d [] allocatedPointsBuf, int maxPoints, SensitivityGradientSettings sensitivitySettings);
